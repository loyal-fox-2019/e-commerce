      ...
      it("should return status 201 and an object", function(done) {
        ...
        chai.request(server)
          ...
          .then(res => {
            ...
            expect(res.body).to.have.keys(["__v", "_id", "name", "image", "description", "price", "stock", "weight"])
            done();
          })
          .catch(done)
        })
    ...
    describe("Successful", function() {
      it("should return status 200 and array of product object", function(done) {
        ...
        .then(function(res) {
          ...
          expect(res.body).to.all.have.keys(["__v", "_id", "name", "image", "price", "description", "stock", "weight"])
          done();
        })
        .catch(done)
      })
