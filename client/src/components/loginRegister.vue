    ...
    <div class="panel">
      ...
      <div class="login">
        ...
        <div class="group">
          ...
          <input v-model="email" type="text" id="email" placeholder="E-Mail" />
      ...
      <div class="register">
        ...
        <div class="inner">
          ...
          <div class="group">
            ...
            <input v-model="phone" type="text" id="phone" placeholder="Phone" />
...
.register .group input[type="text"]::-webkit-input-placeholder,
.register .group input[type="password"]::-webkit-input-placeholder {
  color: #ffffff;
}
