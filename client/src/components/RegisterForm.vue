<template>
   <form @submit.prevent="registerSubmit" class="flex flex-col py-8 px-6 bg-clouds text-midnightblue text-xl font-semibold rounded-lg">
      <h2 class="border-b border-gray-500 mb-4">Register</h2>
      ...
      <input class="cursor-pointer bg-midnightblue text-clouds rounded py-1 hover:text-orange-400" type="submit" value="Register">
   </form>
</template>
